...
function cargarImagenes() {
    imgFondo = new Image();
    imgFondo.src = 'imagenesFlappymario/fondofinal.jpg';
    imgTuboA = new Image();
    imgTuboA.src = 'imagenesFlappymario/tuberia.png';
    imgTuboB = new Image();
    imgTuboB.src = 'imagenesFlappymario/tuberiab.png';
    imgAveA = new Image();
    imgAveA.src = 'imagenesFlappymario/avev11.png';
}
